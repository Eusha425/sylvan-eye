<?php 
	...
	if(isset($_GET['temperature']) && isset($_GET['humidity']) && isset($_GET['condition']) && isset($_GET['timestamp']) && isset($_GET['temp_thresh']) && isset($_GET['humidity_thresh'])) { 					// Check if temprature is present or not
